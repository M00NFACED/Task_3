...
public class ArrayUtils {
    ...
    public static char[] toCharArray(String str) {
        ...
        // из List<Character> можно получить Character[]
    ...
    */
    ...
    public static char[][] toCharArray2(String[] lines) {
        char[][] arr2 = new char[lines.length][];
        for (int r = 0; r < lines.length; r++) {
            arr2[r] = toCharArray(lines[r]);
        }
        return arr2;
    }
    ...
    public static char[][] readCharArray2FromFile(String fileName) {
        try {
            return toCharArray2(readLinesFromFile(fileName));
        } catch (FileNotFoundException e) {
            return null;
        }
    }
